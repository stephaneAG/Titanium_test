...
//@interface mobileOrderAppObject : NSObject
//@end

@interface mobileOrderAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[mobileOrderAppObject class]])
		{
			for (NSString *key in [[(mobileOrderAppObject*)o modules] allKeys])
			{
