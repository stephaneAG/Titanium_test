...
-(id)call:(NSArray*)args
{
	...
	{
		@throw [NSException exceptionWithName:@"org.gesturesdebugapp.kroll" reason:[NSString stringWithFormat:@"invalid method '%@'",NSStringFromSelector(selector)] userInfo:nil];
	}
	NSInvocation *invoker = [NSInvocation invocationWithMethodSignature:methodSignature];
