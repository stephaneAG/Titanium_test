...
//@interface gesturesDebugAppObject : NSObject
//@end

@interface gesturesDebugAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[gesturesDebugAppObject class]])
		{
			for (NSString *key in [[(gesturesDebugAppObject*)o modules] allKeys])
			{
