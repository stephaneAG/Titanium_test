...
// in simulator we redefine to format for gesturesDebugApp Developer console
...
{\
	NSString * exceptionName = [@"org.gesturesdebugapp." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.gesturesdebugapp";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIgesturesDebugAppNativeItemNone = -1, 
	UIgesturesDebugAppNativeItemSpinner = -2,
	UIgesturesDebugAppNativeItemProgressBar = -3,
	
	UIgesturesDebugAppNativeItemSlider = -4,
	UIgesturesDebugAppNativeItemSwitch = -5,
	UIgesturesDebugAppNativeItemMultiButton = -6,
	UIgesturesDebugAppNativeItemSegmented = -7,
	
	UIgesturesDebugAppNativeItemTextView = -8,
	UIgesturesDebugAppNativeItemTextField = -9,
	UIgesturesDebugAppNativeItemSearchBar = -10,
	
	UIgesturesDebugAppNativeItemPicker = -11,
	UIgesturesDebugAppNativeItemDatePicker = -12,
	
	UIgesturesDebugAppNativeItemInfoLight = -13,
	UIgesturesDebugAppNativeItemInfoDark = -14,
	
	UIgesturesDebugAppNativeItemDisclosure = -15,
	
	UIgesturesDebugAppNativeItemContactAdd = -16
};
