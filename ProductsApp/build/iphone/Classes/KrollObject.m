...
//@interface ProductsAppObject : NSObject
//@end

@interface ProductsAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ProductsAppObject class]])
		{
			for (NSString *key in [[(ProductsAppObject*)o modules] allKeys])
			{
