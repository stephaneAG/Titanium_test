...
// in simulator we redefine to format for ProductsApp Developer console
...
{\
	NSString * exceptionName = [@"org.productsapp." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.productsapp";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIProductsAppNativeItemNone = -1, 
	UIProductsAppNativeItemSpinner = -2,
	UIProductsAppNativeItemProgressBar = -3,
	
	UIProductsAppNativeItemSlider = -4,
	UIProductsAppNativeItemSwitch = -5,
	UIProductsAppNativeItemMultiButton = -6,
	UIProductsAppNativeItemSegmented = -7,
	
	UIProductsAppNativeItemTextView = -8,
	UIProductsAppNativeItemTextField = -9,
	UIProductsAppNativeItemSearchBar = -10,
	
	UIProductsAppNativeItemPicker = -11,
	UIProductsAppNativeItemDatePicker = -12,
	
	UIProductsAppNativeItemInfoLight = -13,
	UIProductsAppNativeItemInfoDark = -14,
	
	UIProductsAppNativeItemDisclosure = -15,
	
	UIProductsAppNativeItemContactAdd = -16
};
