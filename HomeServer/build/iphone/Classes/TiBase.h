...
// in simulator we redefine to format for HomeServer Developer console
...
{\
	NSString * exceptionName = [@"org.homeserver." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.homeserver";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIHomeServerNativeItemNone = -1, 
	UIHomeServerNativeItemSpinner = -2,
	UIHomeServerNativeItemProgressBar = -3,
	
	UIHomeServerNativeItemSlider = -4,
	UIHomeServerNativeItemSwitch = -5,
	UIHomeServerNativeItemMultiButton = -6,
	UIHomeServerNativeItemSegmented = -7,
	
	UIHomeServerNativeItemTextView = -8,
	UIHomeServerNativeItemTextField = -9,
	UIHomeServerNativeItemSearchBar = -10,
	
	UIHomeServerNativeItemPicker = -11,
	UIHomeServerNativeItemDatePicker = -12,
	
	UIHomeServerNativeItemInfoLight = -13,
	UIHomeServerNativeItemInfoDark = -14,
	
	UIHomeServerNativeItemDisclosure = -15,
	
	UIHomeServerNativeItemContactAdd = -16
};
