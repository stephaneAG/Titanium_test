...
//@interface HomeServerObject : NSObject
//@end

@interface HomeServerObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[HomeServerObject class]])
		{
			for (NSString *key in [[(HomeServerObject*)o modules] allKeys])
			{
