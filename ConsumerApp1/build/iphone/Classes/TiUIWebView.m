...
static NSString * const kConsumerApp1Javascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_consumerapp1Injection
{
	...
	[html appendString:kConsumerApp1Javascript];
...
{
	// attempt to make well-formed HTML and inject in our ConsumerApp1 bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _consumerapp1Injection]];
	...
	else
	{
		...
		if ([[NSFileManager defaultManager] fileExistsAtPath:path])
		{
			...
			else
			{
				...
				{
					NSLog(@"[WARN] I have no idea what the appropriate text encoding is for: %@. Please report this to ConsumerApp1 support.",url);
				}
			}
