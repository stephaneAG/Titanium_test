...
// in simulator we redefine to format for ConsumerApp1 Developer console
...
{\
	NSString * exceptionName = [@"org.consumerapp1." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.consumerapp1";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIConsumerApp1NativeItemNone = -1, 
	UIConsumerApp1NativeItemSpinner = -2,
	UIConsumerApp1NativeItemProgressBar = -3,
	
	UIConsumerApp1NativeItemSlider = -4,
	UIConsumerApp1NativeItemSwitch = -5,
	UIConsumerApp1NativeItemMultiButton = -6,
	UIConsumerApp1NativeItemSegmented = -7,
	
	UIConsumerApp1NativeItemTextView = -8,
	UIConsumerApp1NativeItemTextField = -9,
	UIConsumerApp1NativeItemSearchBar = -10,
	
	UIConsumerApp1NativeItemPicker = -11,
	UIConsumerApp1NativeItemDatePicker = -12,
	
	UIConsumerApp1NativeItemInfoLight = -13,
	UIConsumerApp1NativeItemInfoDark = -14,
	
	UIConsumerApp1NativeItemDisclosure = -15,
	
	UIConsumerApp1NativeItemContactAdd = -16
};
