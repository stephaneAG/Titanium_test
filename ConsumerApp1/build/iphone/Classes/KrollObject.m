...
//@interface ConsumerApp1Object : NSObject
//@end

@interface ConsumerApp1Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ConsumerApp1Object class]])
		{
			for (NSString *key in [[(ConsumerApp1Object*)o modules] allKeys])
			{
