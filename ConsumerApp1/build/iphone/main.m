...
NSString * const TI_APPLICATION_ID = @"ConsumerApp1";
NSString * const TI_APPLICATION_PUBLISHER = @"stephaneadamgarnier";
NSString * const TI_APPLICATION_URL = @"http://";
NSString * const TI_APPLICATION_NAME = @"ConsumerApp1";
NSString * const TI_APPLICATION_VERSION = @"1.0";
NSString * const TI_APPLICATION_DESCRIPTION = @"not specified";
NSString * const TI_APPLICATION_COPYRIGHT = @"2011 by stephaneadamgarnier";
NSString * const TI_APPLICATION_GUID = @"12ccd875-20e6-4cff-964d-a39a14cda16b";
