...
// in simulator we redefine to format for showroomApp Developer console
...
{\
	NSString * exceptionName = [@"org.showroomapp." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.showroomapp";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIshowroomAppNativeItemNone = -1, 
	UIshowroomAppNativeItemSpinner = -2,
	UIshowroomAppNativeItemProgressBar = -3,
	
	UIshowroomAppNativeItemSlider = -4,
	UIshowroomAppNativeItemSwitch = -5,
	UIshowroomAppNativeItemMultiButton = -6,
	UIshowroomAppNativeItemSegmented = -7,
	
	UIshowroomAppNativeItemTextView = -8,
	UIshowroomAppNativeItemTextField = -9,
	UIshowroomAppNativeItemSearchBar = -10,
	
	UIshowroomAppNativeItemPicker = -11,
	UIshowroomAppNativeItemDatePicker = -12,
	
	UIshowroomAppNativeItemInfoLight = -13,
	UIshowroomAppNativeItemInfoDark = -14,
	
	UIshowroomAppNativeItemDisclosure = -15,
	
	UIshowroomAppNativeItemContactAdd = -16
};
