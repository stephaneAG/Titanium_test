...
//@interface showroomAppObject : NSObject
//@end

@interface showroomAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[showroomAppObject class]])
		{
			for (NSString *key in [[(showroomAppObject*)o modules] allKeys])
			{
