...
//var userPicsFolder = Ti.Filesystem.getFile( Ti.Filesystem.applicationDataDirectory,'userPictures' );
//var f = Ti.Filesystem.getFile(Ti.Filesystem.applicationDataDirectory,'myFile.txt');
//var appDir = Titanium.Filesystem.getFile( Titanium.Filesystem.applicationDataDirectory );
//userPicsFolder.createDirectory();
//Ti.API.info( 'Directory listing: ' + appDir.getDirectoryListing() );
