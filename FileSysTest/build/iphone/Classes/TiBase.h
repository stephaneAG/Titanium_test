...
// in simulator we redefine to format for FileSysTest Developer console
...
{\
	NSString * exceptionName = [@"org.filesystest." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.filesystest";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIFileSysTestNativeItemNone = -1, 
	UIFileSysTestNativeItemSpinner = -2,
	UIFileSysTestNativeItemProgressBar = -3,
	
	UIFileSysTestNativeItemSlider = -4,
	UIFileSysTestNativeItemSwitch = -5,
	UIFileSysTestNativeItemMultiButton = -6,
	UIFileSysTestNativeItemSegmented = -7,
	
	UIFileSysTestNativeItemTextView = -8,
	UIFileSysTestNativeItemTextField = -9,
	UIFileSysTestNativeItemSearchBar = -10,
	
	UIFileSysTestNativeItemPicker = -11,
	UIFileSysTestNativeItemDatePicker = -12,
	
	UIFileSysTestNativeItemInfoLight = -13,
	UIFileSysTestNativeItemInfoDark = -14,
	
	UIFileSysTestNativeItemDisclosure = -15,
	
	UIFileSysTestNativeItemContactAdd = -16
};
