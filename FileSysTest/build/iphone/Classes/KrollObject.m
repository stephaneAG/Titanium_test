...
//@interface FileSysTestObject : NSObject
//@end

@interface FileSysTestObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[FileSysTestObject class]])
		{
			for (NSString *key in [[(FileSysTestObject*)o modules] allKeys])
			{
