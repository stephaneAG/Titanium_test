...
// in simulator we redefine to format for A Developer console
...
{\
	NSString * exceptionName = [@"org.a." stringByAppendingString:NSStringFromClass([self class])];\
...
enum {
	UIANativeItemNone = -1, 
	UIANativeItemSpinner = -2,
	UIANativeItemProgressBar = -3,
	
	UIANativeItemSlider = -4,
	UIANativeItemSwitch = -5,
	UIANativeItemMultiButton = -6,
	UIANativeItemSegmented = -7,
	
	UIANativeItemTextView = -8,
	UIANativeItemTextField = -9,
	UIANativeItemSearchBar = -10,
	
	UIANativeItemPicker = -11,
	UIANativeItemDatePicker = -12,
	
	UIANativeItemInfoLight = -13,
	UIANativeItemInfoDark = -14,
	
	UIANativeItemDisclosure = -15,
	
	UIANativeItemContactAdd = -16
};
