...
// in simulator we redefine to format for PostApp Developer console
...
{\
	NSString * exceptionName = [@"org.postapp." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.postapp";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIPostAppNativeItemNone = -1, 
	UIPostAppNativeItemSpinner = -2,
	UIPostAppNativeItemProgressBar = -3,
	
	UIPostAppNativeItemSlider = -4,
	UIPostAppNativeItemSwitch = -5,
	UIPostAppNativeItemMultiButton = -6,
	UIPostAppNativeItemSegmented = -7,
	
	UIPostAppNativeItemTextView = -8,
	UIPostAppNativeItemTextField = -9,
	UIPostAppNativeItemSearchBar = -10,
	
	UIPostAppNativeItemPicker = -11,
	UIPostAppNativeItemDatePicker = -12,
	
	UIPostAppNativeItemInfoLight = -13,
	UIPostAppNativeItemInfoDark = -14,
	
	UIPostAppNativeItemDisclosure = -15,
	
	UIPostAppNativeItemContactAdd = -16
};
