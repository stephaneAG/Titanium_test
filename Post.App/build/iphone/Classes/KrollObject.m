...
//@interface PostAppObject : NSObject
//@end

@interface PostAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[PostAppObject class]])
		{
			for (NSString *key in [[(PostAppObject*)o modules] allKeys])
			{
