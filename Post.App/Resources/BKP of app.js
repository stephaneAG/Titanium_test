...
Ti.App.addEventListener('postPublished',postPublished);Ti.App.addEventListener('postPublished',postPublished);
...
win2.add(post_title_input);

win2.add(post_meta_main_category_for_mobile_table_row_input);
win2.add(post_meta_level_one_category_for_mobile_table_row_input);
win2.add(post_meta_level_two_category_for_mobile_table_row_input);

win2.add(post_meta_reference_produit_input);
win2.add(post_meta_nom_boutique_produit_input);
win2.add(post_meta_categorie_produit_input);
win2.add(post_meta_type_produit_input);

win2.add(updatePostBtn);
