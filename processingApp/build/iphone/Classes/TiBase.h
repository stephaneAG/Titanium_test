...
// in simulator we redefine to format for processingApp Developer console
...
{\
	NSString * exceptionName = [@"org.processingapp." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.processingapp";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIprocessingAppNativeItemNone = -1, 
	UIprocessingAppNativeItemSpinner = -2,
	UIprocessingAppNativeItemProgressBar = -3,
	
	UIprocessingAppNativeItemSlider = -4,
	UIprocessingAppNativeItemSwitch = -5,
	UIprocessingAppNativeItemMultiButton = -6,
	UIprocessingAppNativeItemSegmented = -7,
	
	UIprocessingAppNativeItemTextView = -8,
	UIprocessingAppNativeItemTextField = -9,
	UIprocessingAppNativeItemSearchBar = -10,
	
	UIprocessingAppNativeItemPicker = -11,
	UIprocessingAppNativeItemDatePicker = -12,
	
	UIprocessingAppNativeItemInfoLight = -13,
	UIprocessingAppNativeItemInfoDark = -14,
	
	UIprocessingAppNativeItemDisclosure = -15,
	
	UIprocessingAppNativeItemContactAdd = -16
};
