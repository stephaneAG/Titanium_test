...
//@interface processingAppObject : NSObject
//@end

@interface processingAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[processingAppObject class]])
		{
			for (NSString *key in [[(processingAppObject*)o modules] allKeys])
			{
